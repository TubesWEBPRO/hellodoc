        ...
        <div class="container" style="margin-top:-65px; margin-left:-40px; width:1700px;">
            <div data-spy="scroll" data-target=".menu-scrl" data-offset="50">
                ...
                <div id="section1" class="container-fluid" style="padding-bottom:70px">
                    <h2 style="margin-inline-start:auto; margin-bottom:5px;">dr. Inneke Sirowanto, Sp.OG</h2>
                    <a href="#" style="text-decoration: none;color: #3570d2;font-weight: 700;font-size:18px;margin-bottom:30px;">Dokter Kandungan</a>
                    <br><br>
                    <h6>Profil Dokter</h6>
                    <br>
                    <p>dr. Inneke Sirowanto, Sp.OG merupakan Dokter Spesialis Obstetri & Ginekologi (Kebidanan dan Kandungan) yang saat ini berpraktik di RS Awal Bros Tangerang. Adapun layanan yang diberikan oleh beliau, diantaranya: konsultasi kebidanan dan kandungan.</p>
                    <br>
                    <p>dr. Inneke Sirowanto, Sp.OG menyelesaikan studi Spesialisasi Obstetri & Ginekologi di Universitas Hasanuddin. Sebelumnya beliau menempuh pendidikan Kedokteran Umum di Universitas Sam Ratulangi.</p>
                    <br>
                    <h6>Pendidikan</h6>
                    <p>Sp.OG - Spesialis Obstetri & Ginekologi (Kebidanan dan Kandungan) - Universitas Hasanuddin</p>
                
                </div>
                <div id="section2" class="container-fluid" style="padding-top:70px;padding-bottom:70px">
                    <h6>Jadwal Praktek</h6>
                    <a href="#" style="text-decoration: none;color: #3570d2;font-weight: 500;font-size:16px;margin-bottom:30px;">Primaya Hospital Tangerang</a>
                ...
                <div class="p-2 box-filter box-doctor" style="height:558px;">
                    <div class="profil" style="margin:20px; margin-top:15px;">
                        ...
                        <div class="card-doctor-profil">
                            <img src="<?= base_url('assets/dr.5.jpg')?>" alt="" style="border-radius: 100%; margin-top: 0px; text-align:center;" width="150px">
